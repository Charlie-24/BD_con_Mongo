...
# rolla un sistema que \*\*lee datos de sensores DHT11 conectados a un Arduino\*\*, los \*\*envía a través del puerto serie\*\* a un programa en \*\*Java\*\*, que luego \*\*almacena los datos en una base de datos MongoDB\*\*.  
